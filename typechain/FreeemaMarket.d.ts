...
interface FreeemaMarketInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    'Bought(uint256,uint256,address,address)': EventFragment
  }
...
export class FreeemaMarket extends Contract {
  ...
  interface: FreeemaMarketInterface
