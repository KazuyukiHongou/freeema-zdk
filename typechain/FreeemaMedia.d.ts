...
interface FreeemaMediaInterface extends ethers.utils.Interface {
  functions: {
    'ITEM_INSTANCE_ID_OFFSET()': FunctionFragment
    'MINT_WITH_SIG_TYPEHASH()': FunctionFragment
    'PERMIT_TYPEHASH()': FunctionFragment
    'acceptBid(uint256,tuple)': FunctionFragment
    'addItem(bytes32,uint256)': FunctionFragment
    'addItemSale(tuple,tuple,tuple,uint256)': FunctionFragment
    'addItemSaleWithSig(address,tuple,tuple,tuple,tuple,uint256)': FunctionFragment
    ...
    'getItemId(bytes32)': FunctionFragment
    'isApprovedForAll(address,address)': FunctionFragment
    'itemIdToItemSales(uint256)': FunctionFragment
  ...
  encodeFunctionData(
    functionFragment: 'ITEM_INSTANCE_ID_OFFSET',
    values?: undefined
  ): string
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: 'addItemSaleWithSig',
    values: [
      string,
      {
        tokenURI: string
  ...
  encodeFunctionData(functionFragment: 'getItemId', values: [BytesLike]): string
  encodeFunctionData(
    functionFragment: 'isApprovedForAll',
    values: [string, string]
  ): string
  encodeFunctionData(
    functionFragment: 'itemIdToItemSales',
    values: [BigNumberish]
  ): string
  ...
  decodeFunctionResult(functionFragment: 'addItemSale', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'addItemSaleWithSig', data: BytesLike): Result
  ...
  decodeFunctionResult(functionFragment: 'itemIdToItemSales', data: BytesLike): Result
  ...
  events: {
    'AddItemEvent(address,uint256,bytes32,uint256)': EventFragment
    'AddSaleEvent(address,uint256,uint256,uint256,uint256)': EventFragment
  ...
  getEvent(nameOrSignatureOrTopic: 'AddItemEvent'): EventFragment
  getEvent(nameOrSignatureOrTopic: 'AddSaleEvent'): EventFragment
...
export class FreeemaMedia extends Contract {
  ...
  interface: FreeemaMediaInterface

  functions: {
    ITEM_INSTANCE_ID_OFFSET(
    ...
    'addItemSale(tuple,tuple,tuple,uint256)'(
      data: {
        tokenURI: string
        metadataURI: string
        contentHash: BytesLike
    ...
    'addItemSaleWithSig(address,tuple,tuple,tuple,tuple,uint256)'(
      creator: string,
      data: {
        tokenURI: string
        metadataURI: string
  ...
  ITEM_INSTANCE_ID_OFFSET(overrides?: CallOverrides): Promise<BigNumber>
  ...
  getItemId(contentHash: BytesLike, overrides?: CallOverrides): Promise<BigNumber>
  ...
  estimateGas: {
    ...
    itemIdToItemSales(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>
  ...
  populateTransaction: {
    ITEM_INSTANCE_ID_OFFSET(overrides?: CallOverrides): Promise<PopulatedTransaction>
