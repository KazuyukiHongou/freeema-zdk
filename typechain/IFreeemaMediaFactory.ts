...
import type { IFreeemaMedia } from './IFreeemaMedia'

export class IFreeemaMediaFactory {
  static connect(address: string, signerOrProvider: Signer | Provider): IFreeemaMedia {
    return new Contract(address, _abi, signerOrProvider) as IFreeemaMedia
  }
}
